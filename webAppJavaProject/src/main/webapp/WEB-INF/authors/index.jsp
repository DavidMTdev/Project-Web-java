								...
								<div class="col">
									<ul class="list-unstyled mb-0">
										<c:forEach items="${ authors }" var="author">
											<li><a
													href="/webAppJavaProject/authors/?author=<c:out value='${author.getUsername() }' />">
													<c:out value="${ author.getUsername() }" /></a></li>
										</c:forEach>
									</ul>
								</div>
							</div>
						...
						<c:forEach items="${ articles }" var="article">
							<div class="col-lg-4 col-md-6 mb-4">
								<div class="card h-100">
									...
									<div class="card-body">
										<h4 class="card-title">
											<a href="/webAppJavaProject/article/post/?id=<c:out value=" ${
												article.getId() }" />">
